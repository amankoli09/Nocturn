 ...
 */
export declare function createWitnesses(buyerMax: bigint, sellerMin: bigint): NegotiationWitnesses;
/**
 ...
 */
export declare function createStubWitnesses(): NegotiationWitnesses;
